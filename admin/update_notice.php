...
<form method="post">
	...
	<div class="row" style="margin:10px 0 0 2.5rem	">
	...
	<div class="row" style="margin:10px 0 0 0.8rem	">
	...
	<div class="row" style="margin-top:10px">
		...
		<div class="col-sm-2"></div>
		<div class="col-sm-4">
		<input type="submit" value="Update Notice" name="update" class="btn btn-primary"/>
